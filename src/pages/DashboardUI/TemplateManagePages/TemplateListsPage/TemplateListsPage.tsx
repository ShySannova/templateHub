...

                {
                    newTemplate.length !== 0 ?
                                ...
                                <tbody className="table-body">
                                    {
                                        newTemplate?.map((template) => {
                                            const updatedAt = formatToLocalDateTime(template?.updatedAt)?.split(",") as string[]
                                            return (
                                                <tr key={template?._id}>
                                                    <td>
                                                        <input name='checkbox' type="checkbox" />
                        ...
                        <div className='no-templates'>
                            ...
                            <Link to={"/dashboard/templates/create"} className='btn'>Create Template</Link>
                        </div>
                }
